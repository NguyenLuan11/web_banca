...
<html lang="en">
	<head>
		...
		<meta charset="utf-8" />
		<title>Cá Cảnh Shop - View Search</title>
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="conn_data" style="text-align: center;">
                        <table border="1" style="border-collapse: collapse; width: 1130px;">
						...
						?>          
								<tr>
									<td style="width: 110px; height: 120px;"><img style="width: 110px; height: 120px;" src="Image/<?php echo $row['Image']; ?>"></td>
							...
							<?php
													...
													?>
													<tr>
														<td colspan="7"><i>Không tìm thấy kết quả nào!</i></td>
													</tr>
													<?php
												}
											} else {
